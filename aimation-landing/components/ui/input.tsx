    ...
    return (
      <div className="w-full">
        <input
          type={type}
          className={cn(
            "flex h-12 w-full rounded-md border bg-[#1a1a1a] px-4 py-2 text-base text-white font-body shadow-sm transition-colors",
            ...
            error
              ...
              : "border-white/40 focus-visible:border-magenta",
            className
          )}
          ref={ref}
          {...props}
