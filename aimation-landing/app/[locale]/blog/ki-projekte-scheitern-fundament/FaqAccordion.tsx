...
export const FAQ_ITEMS = [
  {
    ...
    answer: 'In fast jedem Discovery-Gespräch zeigt sich dasselbe Muster: nicht das Modell ist das Problem, sondern was darunter liegt. Daten in verschiedenen Systemen ohne klare Zuständigkeit, Compliance-Fragen die niemand vorab gestellt hat, und ein Team das nicht mitgenommen wurde. Das sind die drei häufigsten Stopper. Die Technologie selbst ist dabei oft die kleinste Baustelle.',
  },
  {
