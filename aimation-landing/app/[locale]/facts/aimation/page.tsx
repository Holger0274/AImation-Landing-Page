        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <section aria-labelledby="kerndaten">
            ...
            <dl className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-y-4 gap-x-6 font-inter text-sm">
              ...
              <dd className="text-muted">{isEn ? 'Organisation (consulting and service company)' : 'Organisation (Beratungs- und Dienstleistungsunternehmen)'}</dd>

              <dt className="font-semibold text-ink">{isEn ? 'Legal form' : 'Rechtsform'}</dt>
              ...
              <dt className="font-semibold text-ink">{isEn ? 'Registered office' : 'Sitz'}</dt>
              <dd className="text-muted">Sutte 19, 96049 Bamberg, {isEn ? 'Germany' : 'Deutschland'}</dd>

              <dt className="font-semibold text-ink">{isEn ? 'Managing director' : 'Geschäftsführer'}</dt>
              ...
              <dt className="font-semibold text-ink">{isEn ? 'Service areas' : 'Leistungsbereiche'}</dt>
              <dd className="text-muted">
              ...
              <dt className="font-semibold text-ink">{isEn ? 'Pricing (fixed prices)' : 'Preise (Festpreise)'}</dt>
              <dd className="text-muted">
                <ol className="list-decimal list-inside space-y-1">
              ...
              <dt className="font-semibold text-ink">{isEn ? 'Contact' : 'Kontakt'}</dt>
              <dd className="text-muted">
                <a href="mailto:info@aimation.de" className="text-[#60AFFF] hover:underline">info@aimation.de</a>
              </dd>

              <dt className="font-semibold text-ink">LinkedIn {isEn ? 'Company' : 'Unternehmen'}</dt>
              <dd className="text-muted">
              ...
              <dt className="font-semibold text-ink">LinkedIn {isEn ? 'Founder' : 'Gründer'}</dt>
              <dd className="text-muted">
              ...
              <dd className="text-muted">{isEn ? 'Active' : 'Aktiv'}</dd>
          ...
          <section aria-labelledby="abgrenzung">
            <h2 id="abgrenzung" className="font-heading font-semibold text-ink text-2xl mb-6">
              {isEn ? 'AImation UG: Clarifications' : 'AImation UG: Abgrenzung'}
            </h2>
            <ul className="list-disc list-inside space-y-3 font-inter text-sm text-muted">
              <li>
                {isEn
          ...
          <section aria-labelledby="schreibweisen">
            <h2 id="schreibweisen" className="font-heading font-semibold text-ink text-2xl mb-6">
          ...
          <section aria-labelledby="positionierung">
            <h2 id="positionierung" className="font-heading font-semibold text-ink text-2xl mb-4">
          ...
          <section aria-labelledby="anwendungsfaelle">
            <h2 id="anwendungsfaelle" className="font-heading font-semibold text-ink text-2xl mb-6">
              {isEn ? 'AImation: Use Cases' : 'AImation: Anwendungsfälle'}
            </h2>
            <p className="font-inter text-sm text-dim mb-4">
              {isEn
            ...
            <ul className="space-y-2 font-inter text-sm text-muted">
              {useCases.map((uc, i) => (
                <li key={i}>
                  <span className="font-semibold text-ink">{uc.title}:</span> {uc.desc} ({uc.status})
                </li>
              ))}
            </ul>
          </section>
