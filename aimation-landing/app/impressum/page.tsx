...
export const metadata = {
  title: { absolute: 'Impressum | AImation' },
  description: 'Impressum und rechtliche Angaben von AImation - Holger Peschke, KI-Beratung und Automatisierung für den Mittelstand. Kontakt, Anbieterinformationen gemäß § 5 DDG.',
  robots: {
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-soft-black leading-relaxed">
              Für die Tätigkeit als Unternehmensberater gelten keine spezifischen berufsrechtlichen Regelungen oder Kammerzugehörigkeiten nach deutschem Recht.
            </p>
          </section>
